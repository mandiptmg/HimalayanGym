    ...
    <div id='2' className='container mt-4 py-10 mx-auto'>
      <div className='grid items-center md:grid-cols-2 relative'>
        <div className='relative'>
          ...
          />
          <button className='text-[70px] absolute top-1/2 left-1/2 text-gray-800 animate__heartBeat animate__animated anima  duration-500 animate__infinite animate__slow'>
            <FaPlayCircle />
          </button>
        </div>

        <div className='bg-[#292B2C] shadow-2xl lg:absolute right-0 max-w-xl xl:max-w-3xl p-10 space-y-7 '>
          ...
          <div className='leading-normal space-y-2 font-sans text-base lg:text-lg'>
            <p>
